...
export default function Signup() {
  ...
  async function submitForm(e) {
    e.preventDefault();
    if (e.target.emailPhone.value.trim() && e.target.password.value) {
    ...
    <div className="h-screen flex justify-center items-center">
      ...
      >
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl">ثبت نام</h2>
        ...
        <div className="mt-14">
          ...
          <button
            type="submit"
            className="bg-[#eacc90] w-full mt-7 py-2 text-slate-800 text-sm active:bg-[#c4aa72]"
          >
            ثبت نام کنید
          </button>
        </div>
